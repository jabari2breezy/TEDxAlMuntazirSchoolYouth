...
<span className="font-display text-[16vw] md:text-[14vw] font-black italic tracking-tighter text-[#e62b1e] leading-none">TED</span>
<span className="font-display text-[16vw] md:text-[14vw] font-black italic tracking-tighter text-white leading-none">x</span>
