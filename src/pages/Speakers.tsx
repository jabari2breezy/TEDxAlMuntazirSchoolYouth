...
function TheVoicesTitle() {
  ...
  const rotateX = useTransform(scrollYProgress, [0, 0.6], [0, 15]);
  const scale = useTransform(scrollYProgress, [0, 0.6], [1, 0.9]);

  return (
    <div ref={sectionRef} className="relative h-[200dvh]">
      <motion.div
        style={{ opacity, y, rotateX, scale }}
        className="sticky top-0 h-dvh flex items-center justify-center z-30 pointer-events-none"
      >
        <div className="text-center">
          <h2 className="text-[10vw] md:text-[8vw] font-title font-black uppercase tracking-tighter text-white leading-none">
            The Voices
          </h2>
...
export default function Speakers() {
  ...
  return (
    <div className="relative bg-brand-primary">
      ...
      {/* "The Voices" Title Card — tilts away on scroll */}
      <TheVoicesTitle />
