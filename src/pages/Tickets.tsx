        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div variants={itemVariants} className="bg-brand-surface p-8 md:p-12 border border-brand-outline rounded-sm flex flex-col justify-center text-center">
              ...
              <button disabled className="w-full bg-brand-primary text-brand-background font-title text-xl font-bold uppercase tracking-widest py-5 rounded opacity-50 cursor-not-allowed">
                Coming Soon
              </button>
